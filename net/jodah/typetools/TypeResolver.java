...
public final class TypeResolver
{
    ...
    private static Type reify(final Type genericType, final Map<TypeVariable<?>, Type> typeVariableMap, final Map<ParameterizedType, ReifiedParameterizedType> partial) {
        if (genericType instanceof Class) {
            return genericType;
        }
        if (genericType instanceof ParameterizedType) {
            ...
            if (partial.containsKey(parameterizedType)) {
                final ReifiedParameterizedType res = partial.get(genericType);
            ...
            for (final Type genericTypeArgument : genericTypeArguments) {
                final Type reified = reify(genericTypeArgument, typeVariableMap, partial);
                if (reified != result) {
