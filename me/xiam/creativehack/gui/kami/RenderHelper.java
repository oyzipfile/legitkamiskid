...
public class RenderHelper
{
    ...
    public static void drawRectanglePos(final float x, final float y, final float width, final float height) {
        GL11.glEnable(3042);
        GL11.glBlendFunc(770, 771);
        GL11.glBegin(2);
        GL11.glVertex2d((double)width, (double)y);
        GL11.glVertex2d((double)x, (double)y);
        GL11.glVertex2d((double)x, (double)height);
        GL11.glVertex2d((double)width, (double)height);
        GL11.glEnd();
    }
    ...
    public static void drawTooltip(final int x, final int y, final int width, final int height, final float lineWidth, final float boxR, final float boxG, final float boxB, final float boxA, final float lineR, final float lineG, final float lineB) {
        GL11.glColor4f(boxR, boxG, boxB, boxA);
        drawFilledRectangle((float)x, (float)y, (float)width, (float)height);
        GL11.glPushMatrix();
    ...
    public static void drawText(final int x, final int y, final int color, final String text) {
