...
import me.xiam.creativehack.gui.kami.component.EnumButton.EnumbuttonIndexPoof;
...
import me.xiam.creativehack.gui.kami.component.EnumButton;
...
public class KamiEnumButtonUI extends AbstractComponentUI<EnumButton>
{
    ...
    public void renderComponent(final EnumButton component, final FontRenderer aa) {
        ...
        GL11.glDisable(3553);
        GL11.glColor3f(ColourConverter.toF(KamiGuiColors.GuiC.enumColour.color.getRed()), ColourConverter.toF(KamiGuiColors.GuiC.enumColour.color.getGreen()), ColourConverter.toF(KamiGuiColors.GuiC.enumColour.color.getBlue()));
        GL11.glBegin(1);
