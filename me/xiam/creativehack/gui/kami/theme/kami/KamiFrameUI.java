...
import me.xiam.creativehack.gui.kami.RootLargeFontRenderer;
...
import me.xiam.creativehack.gui.rgui.component.container.use.Frame.FrameDragPoof;
import me.xiam.creativehack.gui.rgui.component.listen.UpdateListener;
import me.xiam.creativehack.gui.rgui.poof.PoofInfo;
import me.xiam.creativehack.gui.rgui.poof.IPoof;
import me.xiam.creativehack.gui.rgui.poof.use.FramePoof;
...
import me.xiam.creativehack.gui.kami.RootFontRenderer;
...
public class KamiFrameUI<T extends Frame> extends AbstractComponentUI<Frame>
{
    ...
    public void renderComponent(final Frame component, final FontRenderer fontRenderer) {
        ...
        GL11.glColor3f(ColourConverter.toF(KamiGuiColors.GuiC.windowOutline.color.getRed()), ColourConverter.toF(KamiGuiColors.GuiC.windowOutline.color.getGreen()), ColourConverter.toF(KamiGuiColors.GuiC.windowOutline.color.getBlue()));
        GL11.glLineWidth(KamiGuiColors.GuiC.windowOutlineWidth.aFloat);
        ...
        if (component.isPinnable()) {
            if (component.isPinned()) {
                GL11.glColor3f(ColourConverter.toF(KamiGuiColors.GuiC.pinnedWindow.color.getRed()), ColourConverter.toF(KamiGuiColors.GuiC.pinnedWindow.color.getGreen()), ColourConverter.toF(KamiGuiColors.GuiC.pinnedWindow.color.getBlue()));
            }
            else {
                GL11.glColor3f(ColourConverter.toF(KamiGuiColors.GuiC.unpinnedWindow.aDouble), ColourConverter.toF(KamiGuiColors.GuiC.unpinnedWindow.aDouble), ColourConverter.toF(KamiGuiColors.GuiC.unpinnedWindow.aDouble));
            }
        ...
        if (component.equals(this.xLineComponent)) {
            GL11.glColor3f(ColourConverter.toF(KamiGuiColors.GuiC.lineWindow.aDouble), ColourConverter.toF(KamiGuiColors.GuiC.lineWindow.aDouble), ColourConverter.toF(KamiGuiColors.GuiC.lineWindow.aDouble));
