...
import me.xiam.creativehack.gui.kami.theme.kami.KamiGuiColors;
...
public class KamiGuiChat extends GuiChat
{
    ...
    protected void calculateCommand(final String line) {
        ...
        final Object o2;
        this.currentFillinLine = alphaCommand.getAliases().stream().filter(alias -> alias.startsWith(args[0])).findFirst().map(s -> {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        GL11.glDisable(3042);
        GL11.glDisable(3553);
        GL11.glColor3f(ColourConverter.toF(KamiGuiColors.GuiC.chatOutline.color.getRed()), ColourConverter.toF(KamiGuiColors.GuiC.chatOutline.color.getGreen()), ColourConverter.toF(KamiGuiColors.GuiC.chatOutline.color.getBlue()));
        GL11.glBegin(1);
