...
public class ChunkFinder extends Module
{
    ...
    public void onUpdate() {
        ...
        MessageSendHelper.sendChatMessage("close file");
        this.logWriterClose();
    }
    
    @Override
    protected void onDisable() {
        MessageSendHelper.sendChatMessage("onDisable");
        this.logWriterClose();
    ...
    private void logWriterOpen() {
        ...
        try {
            ...
            MessageSendHelper.sendChatMessage("onLogStart: " + e.getMessage());
        }
    }
    ...
    private Path getPath() {
        ...
        if (ChunkFinder.mc.isSingleplayer()) {
            try {
                ...
                MessageSendHelper.sendChatMessage("onGetPath: " + e.getMessage());
            }
        ...
        try {
            ...
            MessageSendHelper.sendChatMessage("onCreateFile: " + e2.getMessage());
        }
        return rV;
    }
    ...
    private Path makeMultiplayerDirectory() {
        ...
        switch (this.saveOption.getValue()) {
            ...
            case NHACK_WDL: {
                ...
                rV = new File(rV, folderName);
                if (!rV.exists()) {
                    MessageSendHelper.sendChatMessage("nhack wdl directory doesnt exist: " + folderName);
                    MessageSendHelper.sendChatMessage("creating the directory now. It is recommended to update the ip");
                    break;
                }
                break;
            }
