...
import me.xiam.creativehack.util.ColourUtils;
...
public class Tracers extends Module
{
    ...
    public Tracers() {
        ...
        this.customColours = this.register(Settings.booleanBuilder("Custom Colours").withValue(true).build());
        this.opacity = this.register((Setting<Float>)Settings.floatBuilder("Opacity").withRange(0.0f, 1.0f).withValue(1.0f).build());
        this.r = this.register(Settings.integerBuilder("Red").withMinimum(0).withValue(155).withMaximum(255).withVisibility(v -> this.customColours.getValue()).build());
        this.g = this.register(Settings.integerBuilder("Green").withMinimum(0).withValue(144).withMaximum(255).withVisibility(v -> this.customColours.getValue()).build());
        this.b = this.register(Settings.integerBuilder("Blue").withMinimum(0).withValue(255).withMaximum(255).withVisibility(v -> this.customColours.getValue()).build());
