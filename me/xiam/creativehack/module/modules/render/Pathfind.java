...
@Info(name = "Pathfind", category = Category.MISC, description = "A path finder for AutoWalk")
public class Pathfind extends Module
{
    ...
    public static boolean createPath(final PathPoint end) {
        ...
        if (path == null) {
            MessageSendHelper.sendChatMessage("Failed to create path!");
            return false;
        }
    ...
    public void onUpdate() {
        ...
        if (Pathfind.points.size() <= 1 && Pathfind.to != null) {
            ...
            if ((b && flag) || flag) {
                ...
                Pathfind.to = null;
                if (b) {
                    MessageSendHelper.sendChatMessage("Arrived!");
                }
                else {
                    MessageSendHelper.sendChatMessage("Can't go on: pathfinder has hit dead end");
                }
            }
        }
    }
