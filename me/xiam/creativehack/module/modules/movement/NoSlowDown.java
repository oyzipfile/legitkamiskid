...
public class NoSlowDown extends Module
{
    ...
    public NoSlowDown() {
        ...
        this.eventListener = new Listener<InputUpdateEvent>(event -> {
            if (this.passItemCheck(NoSlowDown.mc.player.getActiveItemStack().getItem()) && !NoSlowDown.mc.player.isRiding()) {
    ...
    private boolean passItemCheck(final Item item) {
        return NoSlowDown.mc.player.isHandActive() && (this.allItems.getValue() || (this.food.getValue() && item instanceof ItemFood) || (this.bow.getValue() && item instanceof ItemBow) || (this.potion.getValue() && item instanceof ItemPotion) || (this.shield.getValue() && item instanceof ItemShield));
    }
}
