...
import me.xiam.creativehack.module.modules.misc.AutoTool;
...
public class Aura extends Module
{
    ...
    private Setting<HitMode> prefer;
    private Setting<Boolean> autoTool;
    ...
    public Aura() {
        ...
        this.prefer = this.register(Settings.e("Prefer", HitMode.SWORD));
        this.autoTool = this.register(Settings.b("Auto Weapon", true));
        ...
        for (final Entity target : Aura.mc.world.loadedEntityList) {
            ...
            if (this.attackPlayers.getValue() && target instanceof EntityPlayer && !Friends.isFriend(target.getName())) {
                if (this.autoTool.getValue()) {
                    AutoTool.equipBestWeapon(this.prefer.getValue());
                }
                this.attack(target);
