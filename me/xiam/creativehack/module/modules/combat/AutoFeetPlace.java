...
@Info(name = "AutoFeetPlace", category = Category.COMBAT, description = "Continually places obsidian around your feet")
public class AutoFeetPlace extends Module
{
    ...
    public void onUpdate() {
        if (AutoFeetPlace.mc.player == null || KamiMod.MODULE_MANAGER.isModuleEnabled(Freecam.class)) {
            return;
        }
