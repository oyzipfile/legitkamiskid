...
import me.xiam.creativehack.command.commands.FriendCommand;
...
public class MidClickFriends extends Module
{
    ...
    private void remove(final String name) {
        ...
        MessageSendHelper.sendChatMessage("&b" + friend2.getUsername() + "&r has been unfriended.");
    }
    ...
    private void add(final String name) {
        ...
        new Thread(() -> {
            ...
            if (f == null) {
                ...
                MessageSendHelper.sendChatMessage("&b" + f.getUsername() + "&r has been friended.");
            }
        }).start();
    }
}
